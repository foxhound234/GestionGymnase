 ...
 Stage StageSport;
        ...
        public void HandleAjouterSalle()
    {
        ...
        catch (IOException e)
        {
           ...
           @FXML
      public void HandleReservationSalle()
      {
           try
        {
            StageSport= new Stage();
            StageSport.setTitle("Réservation Une salle");
            FXMLLoader loader = new FXMLLoader(Mainapp.class.getResource("/vue/ReservationSalle.fxml"));
            AnchorPane rootLayout = (AnchorPane) loader.load();
            Scene scene = new Scene(rootLayout);
            StageSport.setScene(scene);
            StageSport.show();
